...
public class MainActivity extends AppCompatActivity {
    ...
    //MaterialButton
    MaterialButton cloutScore, toFeed_Button;
    ...
    private void initVars(){
        toFeed_Button = findViewById(R.id.toFeed_Button);
        ...
        listView = findViewById(R.id.eventTransactionsListView);
    ...
    private void toFeed_ButtonOnClickListener(){
        toFeed_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toFeed_Intent = new Intent(MainActivity.this, SocialFeed.class);
                startActivity(toFeed_Intent);
            }
        });
    }
    ...
    public void tabLayoutManager(){
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                // Log.d("tabPosition: ", "" + position); /* Log.d test is shown
                // to work index is shown correctly */
    ...
    public void receivedListViewOnClickAlert(String userName){
        final AlertDialog endTransactionAlert =
                new MaterialAlertDialogBuilder(MainActivity.this).create();
        ...
        terribleCompletion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                scrHandle.increaseEndUserScore(userName.trim(), -1);
                pendingRef = mDatabaseRef.getReference(
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerAdapter<MainDataModel, tasksViewHolder> adapter =
                new FirebaseRecyclerAdapter<MainDataModel, tasksViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull tasksViewHolder holder, int position,
                                            @NonNull MainDataModel model) {
                ...
                holder.getAmount
                        .setText(MessageFormat.format("{0}{1}", getString(R.string.usdCurSign),
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        transactionDetailsAlert(dateString, rateString, descString, TransactingUsers);
                    }
                });
            }
        ...
        // This algorithm needs to check to see if the user is returning or if the user opening the app for the first time
        // The reason this needs to be done is because the firstReturnAlertBlock methods need to not show up anymore after the
        // alerts have been fully dismissed.
        DatabaseReference firstTimeCheckIntro = mDatabaseRef.getReference("Users")
                .child(accKey.createAccountKey(mCurrentUser.getEmail()))
     ...
     * And a follow option will be granted upon acceptance. This may be removed as this may be
    ...
    private void confirmationAlert(/*Selected users account name*/String usersName,
            /*Selected users clout score*/String usersCloutScore,
            /*Selected users account email*/String usersEmail){

        final AlertDialog confirm =
                new MaterialAlertDialogBuilder(MainActivity.this).create();
        LinearLayout layout =
        ...
        /*** We'll need to add in a function that grabs the searched userProfile image, but
        ...
        circleImageView.setImageDrawable(getResources()
                .getDrawable(R.drawable.ic_baseline_person_24));

        /*** Image Grab START ***/
        StorageReference mStorageRefPfofPic =
                FirebaseStorage.getInstance()
                        .getReference("user/user/" + usersEmail
                                + "profilepicture" + "." + "jpg");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this,
                        usersName + " has been added to your friends list",
    ...
    private void onStartGetCash(){
        mGetCash.child(accKey.createAccountKey(mCurrentUser.getEmail()))
                .child("Cash").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
    ...
    private void cashButtonHandle(){
        ...
        money.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Read from the database
                mCardInfo.child(accKey.createAccountKey(mCurrentUser.getEmail()))
                        .child("isCardOnFile").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        // This method is called once with the initial value and again
                        // whenever data at this location is updated.
                        ...
                        if(value.equals("NO")){
                            ...
                            button.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent passToCardHandler =
                                            new Intent(MainActivity.this,
                                                    LoadCashActivity.class);
                            ...
                            if(value.equals("YES")) {
                                ...
                                trackYES.setNegativeButton("Not Right Now",
    ...
    private void adjustCashVal(){
        mVal.child(accKey.createAccountKey(mCurrentUser.getEmail()))
                .child("Cash").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // This method is called once with the initial value and again
    ...
    private void getUsernameOnStart(){
        // Read from the database
        getAccountKeyRef.child(accKey.createAccountKey(mCurrentUser.getEmail()))
    ...
    private void createTransactionAlert(){
        ...
        eventTransButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confirm.dismiss();
                Intent passToEventTransaction
                        = new Intent(MainActivity.this, EventTransactionActivity.class);
        ...
        PreFundedMoneyTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                confirm.dismiss();
                Intent passToNonFundedMoneyTransactionActivity =
                        new Intent(MainActivity.this, PreFundedMoneyTransaction.class);
    ...
    private void openAnimations(){
        ObjectAnimator animProfileImage =
                ObjectAnimator.ofFloat(profileImage,
                        "translationX", 30f);
        animProfileImage.setDuration(500);
        animProfileImage.start();

        ObjectAnimator animCashButton = ObjectAnimator.ofFloat(money,
                "translationY", -90f);
    ...
    private void transactionDetailsAlert(/* Get the date from the selected viewHolder */ String date,
        ...
        transactionDetialsAlert
                .setIcon(getResources().getDrawable(R.drawable.ic_baseline_emoji_emotions_24));
        transactionDetialsAlert.setTitle("Transaction Details");
        transactionDetialsAlert
                .setMessage("Users : " + TransactingUsers.replace(" : ", " and ") +
    ...
    private void firstimeCloutScoreOnClickAlert2(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                confirm.dismiss();
                firstTimeCloutScoreOnClickAlert3();
            }
        });
        confirm.show();
    }
    private void firstTimeCloutScoreOnClickAlert3(){
        final AlertDialog confirm = new MaterialAlertDialogBuilder(MainActivity.this).create();
        LinearLayout layout = new LinearLayout(getApplicationContext());
        layout.setOrientation(LinearLayout.VERTICAL);
        confirm.setView(layout);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                confirm.dismiss();
                firstTimeCloutScoreOnClickAlert4();
            }
        });
        confirm.show();
    }
    private void firstTimeCloutScoreOnClickAlert4(){
        final AlertDialog confirm = new MaterialAlertDialogBuilder(MainActivity.this).create();
        LinearLayout layout = new LinearLayout(getApplicationContext());
        layout.setOrientation(LinearLayout.VERTICAL);
        confirm.setView(layout);
